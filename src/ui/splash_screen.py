...
from PyQt6.QtGui import QBrush, QColor, QIcon, QPainter, QPen, QPixmap, QTransform
...
class LoadingIcon(QWidget):
    ...
    def paintEvent(self, event):
        ...
        for i in range(5):
            ...
            x = center_x + dot_pos_radius * (1.0 if i % 2 == 0 else 0.85) * (
                1.0 if i % 3 == 0 else 0.9
            ) * round(math.cos(rad), 5)
            y = center_y + dot_pos_radius * (1.0 if i % 2 == 0 else 0.85) * (
                1.0 if i % 3 == 0 else 0.9
            ) * round(math.sin(rad), 5)
...
class SplashScreen(QSplashScreen):
    ...
    def _create_content(self):
        ...
        self.loading_icon = LoadingIcon(
            color=QColor(52, 152, 219), size=120, icon_path=icon_path
        )
        ...
        self.status_index = 0
        self.status_texts = ["正在初始化资源...", "正在加载组件...", "正在准备主界面...", "即将完成..."]
