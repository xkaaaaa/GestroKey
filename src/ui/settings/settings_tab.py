...
try:
    ...
    from ui.components.dialog import (
        connect_page_to_main_window,  # 使用dialog.py中的辅助方法连接到主窗口
    )
...
class SettingsPage(QWidget):
    ...
    def create_brush_settings_page(self):
        ...
        self.pen_width_slider.setSizePolicy(
        ...
        self.pen_width_spinner.setSizePolicy(
        ...
        self.color_picker.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self.preview_widget = PenPreviewWidget(
            self.settings.get("pen_width"), self.settings.get("pen_color")
        )
    ...
    def create_app_settings_page(self):
        ...
        self.startup_checkbox = AnimatedCheckBox(
            "开机自启动", primary_color=[52, 152, 219]
        )  # 使用蓝色主题
    ...
    def reset_settings(self):
        ...
        self.request_dialog.emit(
            "question", f"确认重置", "是否确定将所有设置重置为默认值？", self._on_reset_dialog_result
        )
    ...
    def save_settings(self):
        ...
        try:
            ...
            autostart_changed = (
                ...
                != self.settings.is_autostart_enabled()
            )
    ...
    def _update_drawing_manager(self):
        ...
        try:
            ...
            if hasattr(main_window, "console_tab") and main_window.console_tab:
                ...
                if (
                    hasattr(console_tab, "drawing_manager")
                    and console_tab.drawing_manager
                ):
